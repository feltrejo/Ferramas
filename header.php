...
$query = $conn->query("SELECT id_tipo_producto, nombre_tipo FROM tipo_producto");
$tipos_producto = [];
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <?php if ($current_page == 'productos.php' || $current_page == 'categoria.php'): ?>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="categoriasDropdown">
                        <?php foreach ($tipos_producto as $tipo): ?>
                            <li><a class="dropdown-item" href="categoria.php?tipo=<?= $tipo['id_tipo_producto'] ?>"><?= htmlspecialchars($tipo['nombre_tipo']) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                <?php elseif (isset($_SESSION['role']) && $_SESSION['role'] == 'user'): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="ofertas.php">Ofertas</a></li>
                <?php endif; ?>
                <li class="nav-item">
